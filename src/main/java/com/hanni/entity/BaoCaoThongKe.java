...
/**
 *
 * @author VietAn numberone
 */
public class BaoCaoThongKe {

    @Override
	public String toString() {
		return "/nBaoCaoThongKe [maDH=" + maDH + ", tenKhachHang=" + tenKhachHang + ", TenSanPham=" + TenSanPham
				+ ", NgayLap=" + NgayLap + ", TongTien=" + TongTien + ", TrangThai=" + TrangThai + ", soLuong="
				+ soLuong + ", donGia=" + donGia + ", doanhThu=" + doanhThu + ", ngay=" + ngay + ", thang=" + thang
				+ ", nam=" + nam + "]/n";
	}
