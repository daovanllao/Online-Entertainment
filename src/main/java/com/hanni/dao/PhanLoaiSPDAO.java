...
public class PhanLoaiSPDAO extends HanniDAO<PhanLoaiSP, String>{
    final String INSERT_SQL = "INSERT INTO PhanLoaiSP(MaPL, TenPL, ThongTin) VALUES(?,?,?)";
    final String UPDATE_SQL = "UPDATE PhanLoaiSP SET TenPL =?, ThongTin =? WHERE MaPL = ?";
    ...
    public void update(PhanLoaiSP entity) {
        JdbcHelper.update(UPDATE_SQL, entity.getTenPL(), entity.getThongTin(),entity.getMaPL());
    }
